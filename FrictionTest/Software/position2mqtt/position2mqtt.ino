...
char subTopic[] = "arduino/pos1cmd";     //payload[0] will control/set LED
char pubTopic[] = "arduino/pos";       //payload[0] will have ledState value
...
String getPos(){
  ...
  float  pos1 = map(volt1, 0, 3.3, 0, 100);
